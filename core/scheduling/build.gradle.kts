...
// Cloud-only background scheduling (WorkManager + Hilt-Work). Linked into the app via
// cloudImplementation only, so androidx.work never reaches the LOCAL build.
plugins {
...
android {
    namespace = "com.buzbuz.smartautoclicker.core.scheduling"
}
